...
class FilesFrame(CTkFrame):
    def __init__(
        ...
        CTkLabel(self, text='Arquivos', **label_settings).grid(row=0, column=0, columnspan=2, pady=(10, 0))

        CTkButton(self, text='Novo', command=new_db_handler, **button_settings).grid(row=1, column=0, **pad)
