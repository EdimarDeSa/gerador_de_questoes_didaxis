...
class GeneralPramsFrame(CTkFrame):
    def __init__(
        ...
        save_user_settings_handler: Callable,
        var_erase_statement: Variable,
        var_auto_export: Variable,
        var_aparencia_do_sistema: Variable,
        change_appearance_handler: Callable,
        var_escala_do_sistema: Variable,
        change_scale_handler: Callable,
        **kwargs
    ):
        ...
        self._var_erase_statement_on_off = StringVar(
            value=self.check_state(var_erase_statement.get())
        )
        ...
        CTkSwitch(
            self,
            variable=self.var_erase_statement,
            text=None,
            width=0,
            switch_width=75,
            command=self.change_erase_statement,
        ...
        CTkSwitch(
            ...
            width=0,
            switch_width=75,
            command=self.change_auto_exportar,
        ...
        CTkOptionMenu(
            ...
            variable=self.var_aparencia_do_sistema,
        ...
        CTkOptionMenu(
            self,
            values=SCALELIST,
            variable=self.var_escala_do_sistema,
