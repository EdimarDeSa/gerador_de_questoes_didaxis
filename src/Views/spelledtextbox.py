...
from src.Constants import MAXIMO_DE_CARACTERES, RED, ADD
...
class SpelledTextBox(CTkTextbox, SpelledTextBoxContract):
    def __init__(self, master, input_speller_queue: Callable, **kwargs):
        ...
        self.palavras_com_suggests: Dict[str, TagSettings] = {}
        self.input_speller_queue = input_speller_queue
        self.cmd_add_new_word = None
    ...
    def register_new_word_cmd(self, cmd_add_new_word: Callable) -> None:
