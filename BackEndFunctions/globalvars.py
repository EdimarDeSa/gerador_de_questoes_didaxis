...
# from BackEndFunctions.corretor_ortografico import SpellerManager
# from constants import PLACE_HOLDER_TEMPO, PLACE_HOLDER_PESO, D, VF, ME, MEN
# from BackEndFunctions.questions_manager import QuestionsManager
#
#
...
#         self._cnf = configs_manager
#         self._quest = question_manager
#
#         # Variáveis de perfil
#         self.var_apagar_enunciado: BooleanVar = BooleanVar(value=self._cnf.apagar_enunciado)
#         self.var_exportar_automaticamente: BooleanVar = BooleanVar(value=self._cnf.apagar_enunciado)
...
#
#         # Funcoes de Controle
#         self.corretor_ortografico: SpellerManager | None = None
#         self.exportar = None
#         self.exit = None
